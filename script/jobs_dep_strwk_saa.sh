...
#SBATCH --array=1-3230
#SBATCH --output=../slurm/strwk/saa/%A_%a.out
...
do  
    ...
    do
        ...
        then
            ./exe -instancefile "../data/instances/${instance}${seed}_mod.txt" -follower 1 -dep_strwk 0 -sol $approach -near_opt 1 -eps_near_opt $epsnearopt -nbthreads $nbthreads -timelimit $timelimit -verbose $verbose -nbproblemsSAA $nbproblems -nbscenariosSAA $nbscenarios -nbvalidateproblems $nbvalidateproblems -nbvalidatescenarios $nbvalidatescenarios -nbvalidatethinning $nbvalidatethinning
        fi
        (( i = $i +1 ))
        ...
        do
            if [ $SLURM_ARRAY_TASK_ID -eq $i ]
            then
                ./exe -instancefile "../data/instances/${instance}${seed}_mod.txt" -follower 1 -dep_strwk 2 -str_param $param -sol $approach -near_opt 1 -eps_near_opt $epsnearopt -nbthreads $nbthreads -timelimit $timelimit -verbose $verbose -nbproblemsSAA $nbproblems -nbscenariosSAA $nbscenarios -nbvalidateproblems $nbvalidateproblems -nbvalidatescenarios $nbvalidatescenarios -nbvalidatethinning $nbvalidatethinning
            fi
            (( i = $i +1 ))
        done
        ...
        do
            if [ $SLURM_ARRAY_TASK_ID -eq $i ]
            then
                ./exe -instancefile "../data/instances/${instance}${seed}_mod.txt" -follower 1 -dep_strwk 3 -frag_param $param -sol $approach -near_opt 1 -eps_near_opt $epsnearopt -nbthreads $nbthreads -timelimit $timelimit -verbose $verbose -nbproblemsSAA $nbproblems -nbscenariosSAA $nbscenarios -nbvalidateproblems $nbvalidateproblems -nbvalidatescenarios $nbvalidatescenarios -nbvalidatethinning $nbvalidatethinning
            fi
            (( i = $i +1 ))
        done
        ...
        do
            if [ $SLURM_ARRAY_TASK_ID -eq $i ]
            then
                ./exe -instancefile "../data/instances/${instance}${seed}_mod.txt" -follower 1 -dep_strwk 4 -str_pow_param $param -sol $approach -near_opt 1 -eps_near_opt $epsnearopt -nbthreads $nbthreads -timelimit $timelimit -verbose $verbose -nbproblemsSAA $nbproblems -nbscenariosSAA $nbscenarios -nbvalidateproblems $nbvalidateproblems -nbvalidatescenarios $nbvalidatescenarios -nbvalidatethinning $nbvalidatethinning
            fi
            (( i = $i +1 ))
        done
        ...
        do
            if [ $SLURM_ARRAY_TASK_ID -eq $i ]
            then
                ./exe -instancefile "../data/instances/${instance}${seed}_mod.txt" -follower 1 -dep_strwk 5 -frag_pow_param $param -sol $approach -near_opt 1 -eps_near_opt $epsnearopt -nbthreads $nbthreads -timelimit $timelimit -verbose $verbose -nbproblemsSAA $nbproblems -nbscenariosSAA $nbscenarios -nbvalidateproblems $nbvalidateproblems -nbvalidatescenarios $nbvalidatescenarios -nbvalidatethinning $nbvalidatethinning
            fi
            (( i = $i +1 ))
        done
    done
